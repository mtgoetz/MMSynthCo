...
//
//	this->encoder = new RotaryEncoder(pinA, pinB, RotaryEncoder::LatchMode::TWO03);
//	//attachInterrupt(digitalPinToInterrupt(pinA), this->encCallback, CHANGE);
//
//
...
//
//		//obs: maybe this should be outside of the above condition
//		if (buttonState == LOW) {
